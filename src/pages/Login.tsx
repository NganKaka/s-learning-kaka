  ...
  return (
    <PageShell>
      <div className="max-w-md mx-auto">
        <SectionHeading eyebrow="Auth" title="Đăng nhập" subtitle="Chào mừng bạn quay lại." />
        ...
        >
          ...
          <div className="flex items-center gap-3 my-1">
            ...
            <span className="font-tech text-[9px] uppercase tracking-[0.2em] text-secondary/45">
              hoặc
            </span>
            <span className="flex-1 h-px bg-white/10" />
          </div>
