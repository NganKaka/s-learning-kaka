      ...
      <section id="hero" className="relative pt-12 md:pt-20 grid lg:grid-cols-[1.2fr_0.8fr] gap-10 items-center">
        <div className="space-y-7">
          ...
          <p className="text-lg md:text-xl font-headline font-bold">
            <GradientText text="Khoá học lập trình & kỹ năng — dạy bởi Vo Hoang Ngan" />
          </p>
          <p className="text-secondary/85 leading-relaxed max-w-xl">
            Video bài giảng chất lượng cao, flashcard ôn tập theo phương pháp lặp lại ngắt quãng,
        ...
        <div className="glass-card rounded-3xl p-6 ambient-shadow space-y-4">
          ...
          <Link
            to="/dashboard"
            className="block text-center text-xs font-tech uppercase tracking-[0.18em] text-cyan-300 hover:text-cyan-200 pt-2"
          >
            Vào bảng điều khiển →
          </Link>
        </div>
        ...
        <section id="how-it-works">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-5">
            {[
              ...
              <div key={item.title} className="glass-card rounded-2xl p-6 space-y-2">
                <p className="font-tech text-[10px] uppercase tracking-[0.18em] text-primary">{item.title}</p>
